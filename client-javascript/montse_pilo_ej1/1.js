...
// cambio letras a violeta de la etiqueta <p>
...
// Rota el matiz de los colores de todas las imágenes
...
nuevaEtiqueta.style.fontWeight = 'bold'; // Negrita (similar a h1)
nuevaEtiqueta.style.textAlign = 'center'; // Alineación centrada
nuevaEtiqueta.style.color = 'blue'; // Espacio debajo del elemento
