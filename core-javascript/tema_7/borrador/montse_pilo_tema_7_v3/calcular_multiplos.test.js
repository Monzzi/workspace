// Importamos solo la función que vamos a probar
...
describe('obtenerMultiplos', () => {
    ...
    test('Debe lanzar un error si el tamaño es 0', () => {
    ...
    test('Debe lanzar un error si el tamaño o número no se pasan como parámetros', () => {
        expect(() => obtenerMultiplos()).toThrow('El tamaño del array y el número base deben ser mayores a 0');
    });
