...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>25 de Noviembre: Día Internacional de la Eliminación de la Violencia contra la Mujer</title>
    <style>
        body {
...
<body>
    <header>
        <h1>25 de Noviembre</h1>
        <p>Día Internacional de la Eliminación de la Violencia contra la Mujer</p>
    </header>
    <div class="container">
        <div class="content">
            <h2>Reivindicamos la erradicación de la violencia de género</h2>
            <p>Hoy, <span class="highlight">25 de noviembre</span>, nos unimos al llamado mundial para poner fin a la violencia contra las mujeres y niñas. Esta fecha nos recuerda la urgente necesidad de:</p>
            <ul>
                <li>Crear conciencia sobre la violencia de género</li>
                <li>Apoyar a las sobrevivientes</li>
                <li>Promover la igualdad de género</li>
                <li>Educar para prevenir la violencia</li>
            </ul>
            <p>Juntos, podemos construir un mundo donde todas las personas vivan libres de violencia y discriminación.</p>
            <p class="highlight">¡Alcemos nuestras voces por un futuro sin violencia de género!</p>
        </div>
    </div>
</body>
</html>
...
// Función para seleccionar el contenido
...
// Variable para seleccionar la opción (0: Present, 1: Future, 2: Monzzi, otros: Error)
const selectedOption = 2; // Cambia este valor para probar diferentes opciones

// Asignar el contenido al elemento
this.innerHTML = getHTML(selectedOption);
